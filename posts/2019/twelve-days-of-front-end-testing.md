...
1. Running pa11y tests on homepage at various screen sizes:
...
1. Running pa11y tests on a blog post template at various screen sizes:
...
1. Running BackstopJS on a homepage and blog post template at various screen sizes:
...
1. Running Cypress tests on the homepage:
...
1. Running Cypress tests on a blog post template at various screen sizes:
