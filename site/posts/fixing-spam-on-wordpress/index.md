...
blog: [aimhigher]
featured: /posts/fixing-spam-on-wordpress/feature/photo-1530436098968-cab21a5dfea6.jpg
---
...
![Find Akismet in the plugins section of the WordPress dashboard](/posts/fixing-spam-on-wordpress/install_akismet.png "Screenshot of the WordPress dashboard, in the plugins section")

Navigate to **Settings** → **Akismet Anti-Spam** in the side menu and click **Set up your Akismet account** to register your website

![](/posts/fixing-spam-on-wordpress/akismet_admin.png)
...
![](/posts/fixing-spam-on-wordpress/akismet_plans.png)
...
![](/posts/fixing-spam-on-wordpress/form_captcha.png)

Under **WPForms** → **Settings** → **reCAPTCHA**, you have the options for setting up reCAPTCHA on your forms.

![](/posts/fixing-spam-on-wordpress/wpforms_recaptcha.png)
...
![](/posts/fixing-spam-on-wordpress/new_recaptcha.png)

It will then give you two keys to add the reCAPTCHA to your site, a *Site Key* and a *Secret Key*.

![](/posts/fixing-spam-on-wordpress/recaptcha_api.png)
...
![](/posts/fixing-spam-on-wordpress/wpforms_wp_api.png)
...
![](/posts/fixing-spam-on-wordpress/recaptcha_form.png)
